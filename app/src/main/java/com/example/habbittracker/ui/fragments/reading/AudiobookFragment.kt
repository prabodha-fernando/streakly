...
import com.example.habbittracker.databinding.FragmentAudiobookBinding
...
class AudiobookFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnStartAudioTimer.setOnClickListener { startTimerAndAutoLog(10) }
        binding.btnLogAudio.setOnClickListener { logReadingHabit() }
    ...
    private fun cancelTimer(resetText: Boolean) {
        ...
        isRunning = false
        remainingMillis = 0L
        if (resetText) updateCountdownText(10 * 60 * 1000L)
        binding.btnPauseResume.text = "Pause"
    }
    ...
    private fun updateCountdownText(millis: Long) {
        ...
        binding.textCountdown.text = String.format(java.util.Locale.getDefault(), "%02d:%02d", minutes, seconds)
    }
